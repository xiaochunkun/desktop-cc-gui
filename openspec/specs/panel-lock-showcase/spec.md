# panel-lock-showcase Specification

## Purpose

Define the lock overlay showcase information architecture, live-session visibility scope, and responsive readability constraints.
